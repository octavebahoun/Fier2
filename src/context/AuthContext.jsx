...
export const ROLE_PRESENTATION = {
  ...
  CHERCHEUR:          { label: 'Chercheur FIERI',     short: 'Chercheur',   description: 'Publication scientifique, soumission d\'articles et création de projets.', level: 3, textClassName: 'text-fieri-blue',  badgeClassName: 'bg-accent-primary/15 border-accent-primary/30 text-fieri-blue' },
