...
export const ROLE_PRESENTATION = {
  ...
  CHERCHEUR:      { label: 'Chercheur FIERI',     short: 'Chercheur',    description: 'Publication scientifique, opportunités et projets R&D.',         textClassName: 'text-engine',      badgeClassName: 'bg-engine-wash border-engine text-engine' },
