            ...
            {filteredProjects.map((p, index) => {
              ...
              return (
                <motion.div
                  ...
                  } group relative glass-panel rounded-3xl p-6 md:p-8 flex flex-col justify-between min-h-[380px] overflow-hidden border border-white/5 bg-[#0d1120]/60 backdrop-blur-xl transition-all cursor-pointer`}
                  whileHover={{ 
                    y: -4, 
