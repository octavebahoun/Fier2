        ...
        >
          <div className="inline-flex items-center gap-3 p-1 chamfer-sm bg-engine-wash border border-engine">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 chamfer-sm bg-engine text-on-accent text-xs font-bold hover:bg-engine-deep transition-all cursor-pointer"
            >
              Postuler maintenant
